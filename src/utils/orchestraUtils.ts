...
// Valid orchestra types and locations from backend schema
...
export const VALID_LOCATIONS = [
  ...
  'חדר 1', 'חדר 2', 'חדר חזרות', 'חדר 5', 'חדר 6', 'חדר 7', 'חדר 8',
  'חדר 9', 'חדר 10', 'חדר 11', 'חדר 12', 'חדר 13', 'חדר 14', 'חדר 15',
  'חדר 16', 'חדר 17', 'חדר 18', 'חדר 19', 'חדר 20', 'חדר 21', 'חדר 22',
  'חדר 23', 'חדר 24', 'חדר 25', 'חדר 26', 'חדר תאוריה א', 'חדר תאוריה ב'
] as const;

export type OrchestraType = typeof VALID_ORCHESTRA_TYPES[number];
export type LocationType = typeof VALID_LOCATIONS[number];
