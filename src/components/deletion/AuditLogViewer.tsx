            ...
            <div className="flex gap-2">
              {onExport && (
                ...
                >
                  ...
                  <span className="font-reisinger-michal">יצוא</span>
                </button>
              )}
        ...
        <div className="grid grid-cols-12 gap-4 items-center text-sm font-medium text-gray-700">
          <div className="col-span-3">
            <button
              ...
              className="flex items-center gap-1 hover:text-gray-900 font-reisinger-michal"
            >
          ...
          <div className="col-span-3">
            <span className="font-reisinger-michal">שם ישות</span>
          </div>
                ...
                {isExpanded && (
                  <div className="pt-4 border-t border-gray-100 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h5 className="text-sm font-semibold text-gray-900 mb-2 font-reisinger-michal">
                          פרטי הפעולה
                        </h5>
                        <div className="space-y-1 text-sm text-gray-600">
                          ...
                          <div className="flex items-center gap-2 font-reisinger-michal">
          ...
          <div className="space-y-6 p-6" dir="rtl">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center gap-2 text-blue-700 mb-2">
                ...
                <span className="font-semibold font-reisinger-michal">שחזור נתונים</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="font-medium text-gray-700 font-reisinger-michal">פעולה:</span>
                <span className="text-gray-600 font-reisinger-michal">{getActionLabel(selectedEntry.action)}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="font-medium text-gray-700 font-reisinger-michal">ישות:</span>
                <span className="text-gray-600 font-reisinger-michal">{selectedEntry.entityName}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="font-medium text-gray-700 font-reisinger-michal">תאריך:</span>
                <span className="text-gray-600 font-reisinger-michal">{formatDate(selectedEntry.timestamp)}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="font-medium text-gray-700 font-reisinger-michal">משתמש:</span>
                <span className="text-gray-600 font-reisinger-michal">{selectedEntry.userName}</span>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-center gap-2 text-yellow-700 mb-1">
                ...
                <span className="font-semibold text-sm font-reisinger-michal">שים לב</span>
              </div>
              <p className="text-xs text-yellow-700 font-reisinger-michal">
            ...
            <div className="flex gap-3 pt-4 border-t border-gray-100">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-reisinger-michal"
              >
                שחזר נתונים
              </button>
            </div>
