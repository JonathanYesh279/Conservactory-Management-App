...
export const BarChart: React.FC<BaseChartProps> = ({
  ...
  return (
    <div className={`${className}`} dir="rtl">
      {title && (
        <h4 className="text-sm font-medium text-gray-700 mb-4 font-reisinger-michal">
          {title}
        </h4>
      )}
        ...
        {data.map((item, index) => {
          ...
          return (
            <div key={index} className="flex items-center">
              <div className="w-20 text-sm font-reisinger-michal text-right truncate ml-3">
                {item.label}
              </div>
              ...
              <div className="w-12 text-sm font-medium text-gray-900 text-center mr-3 font-reisinger-michal">
          ...
          {segments.map((segment, index) => (
            <div key={index} className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <span className="text-sm font-reisinger-michal">
                  {segment.label}
                </span>
              </div>
    ...
    <div className={`${className}`} dir="rtl">
      {title && (
        <div className="flex items-center justify-between mb-4">
          <h4 className="text-sm font-medium text-gray-700 font-reisinger-michal">
            {title}
          </h4>
          {trend && (
            <span className={`text-xs font-medium ${getTrendColor()} font-reisinger-michal`}>
      ...
      <div className="relative">
        ...
        <div className="flex justify-between mt-2 px-2">
          {data.map((item, index) => (
            <span
              key={index}
              className="text-xs text-gray-600 font-reisinger-michal"
    ...
    <div className={`flex flex-col items-center ${className}`} dir="rtl">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-xl font-bold text-gray-900 font-reisinger-michal">
            {Math.round(percentage)}%
          </span>
          {subtitle && (
            <span className="text-xs text-gray-600 font-reisinger-michal">
              {subtitle}
            </span>
          )}
        </div>
      ...
      {label && (
        <span className="mt-2 text-sm font-medium text-gray-700 text-center font-reisinger-michal">
          {label}
        </span>
      )}
    </div>
...
export const GaugeChart: React.FC<{
  ...
  return (
    <div className={`${className}`} dir="rtl">
      {title && (
        <h4 className="text-sm font-medium text-gray-700 mb-4 text-center font-reisinger-michal">
          {title}
        </h4>
      )}
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center">
          ...
          <div className="text-xs font-medium font-reisinger-michal" style={{ color: gaugeColor }}>
